...
-- ============================================================
CREATE TABLE IF NOT EXISTS {{ipd_reviewer_profile}} (
...
-- ============================================================
CREATE TABLE IF NOT EXISTS {{ipd_project_binding}} (
  id            BIGINT AUTO_INCREMENT PRIMARY KEY,
...
-- ipd_linked_issue 新增 ONES 权威整改状态快照字段：
...
-- ipd_phase_guard 保存同项目同阶段同类型的活动评审唯一占用记录。

-- ============================================================
-- ipd_review — 新增 Profile 快照字段
-- ============================================================
...
-- ============================================================
-- ipd_review_reviewer — 新增 selection mode 字段
-- ============================================================
